...
namespace VSJamSession.VSThrowawayPackage
{
    ...
    //     - An empty vsthrowawaypackage file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.vsthrowawaypackage. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.vsthrowawaypackage, MyExtFile2.vsthrowawaypackage... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.vsthrowawaypackage|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.vsthrowawaypackage - our empty vsthrowawaypackage file
    ...
    //    - #107 - the ID of "vsthrowawaypackage"
    ///////////////////////////////////////////////////////////////////////////////
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".vsthrowawaypackage";
        ...
        #region Fields
        private VSThrowawayPackagePackage myPackage;
        ...
        public EditorPane(VSThrowawayPackagePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the vsthrowawaypackage document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(VSThrowawayPackagePackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidVSThrowawayPackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVSThrowawayPackageCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidVSThrowawayPackageEditorFactory;
            return VSConstants.S_OK;
        }
