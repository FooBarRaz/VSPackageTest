...
namespace VSJamSession.VSThrowawayPackage
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".vsthrowawaypackage", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "VSThrowawayPackage")]
    [ProvideKeyBindingTable(GuidList.guidVSThrowawayPackageEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidVSThrowawayPackagePkgString)]
    public sealed class VSThrowawayPackagePackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public VSThrowawayPackagePackage()
        {
