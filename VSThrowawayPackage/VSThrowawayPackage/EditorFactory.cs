...
namespace VSJamSession.VSThrowawayPackage
{
    ...
    /// </summary>
    [Guid(GuidList.guidVSThrowawayPackageEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private VSThrowawayPackagePackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(VSThrowawayPackagePackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidVSThrowawayPackageEditorFactory;
            pgrfCDW = 0;
